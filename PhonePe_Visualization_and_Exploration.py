...
with tab1:
    ...
    with col2:
        st.video("C:\\Users\\Asus\\Downloads\\python basic\\guvi-iitm\\DTM9\\dtm-9 phone pe project\\video\\phone pe ad.mp4")

    col3,col4= st.columns(2)
    
    with col3:
        st.video("C:\Users\Asus\Downloads\python basic\guvi-iitm\DTM9\dtm-9 phone pe project\Phone Pe Ad(720P_HD).mp4")
