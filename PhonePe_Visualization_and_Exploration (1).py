...
with tab1:
    ...
    with col2:
        st.image("https://cdn.dribbble.com/users/1902890/screenshots/15619502/media/4110e14facc720955ac1ad0ae1589477.gif",caption="phonepe ad",use_column_width=True)

    col3,col4= st.columns(2)
    
    with col3:
        st.image("https://www.phonepe.com/pulsestatic/767/pulse/static/1ca92fceac99e4712aa74a5e281562c7/bf2fd/spotlight_1.jpg",caption="phonepe data",use_column_width=True)
    ...
    with col6:
        st.image("https://pbs.twimg.com/media/E-a_c2YUYAUqm2W.jpg",caption="phonepe pulse",use_column_width=True)
